...
/**
 * Objects that wrap an individual racer's information need to implement this interface in
 * order for the view classes to know about the Racer. Use this when loading the Header
 * information in the race file.
 * 
